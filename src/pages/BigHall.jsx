...
const BigHall = () => {
    ...
    useEffect(() => {
        const storedOrders = JSON.parse(localStorage.getItem("BigHallOrders")) || [];
        setOrders(storedOrders);
    }, []);

    useEffect(() => {
        localStorage.setItem("BigHallOrders", JSON.stringify(orders));
    }, [orders]);
    ...
    const submitOrder = async () => {
        ...
        try {
            const roomNumber = "BigHall"; // Set Room No. Here (Change dynamically if needed)
            ...
            // alert(`Order from Room submitted successfully!`);

            setOrders([]);
            localStorage.removeItem("BigHallOrders");
        } catch (error) {
